<template>
    <div>
        <h1>Błąd 404 - Przepraszamy, nie znaleziono strony</h1>

        <p>
            Szukana strona nie została znaleziona. Sprawdź, czy adres URL jest poprawny, lub <a href="/">wróć do strony głównej</a>.
        </p>
    </div>
